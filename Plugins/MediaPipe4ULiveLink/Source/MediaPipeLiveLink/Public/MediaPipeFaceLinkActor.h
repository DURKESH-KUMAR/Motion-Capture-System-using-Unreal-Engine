...
public:
	...
	UFUNCTION(BlueprintPure, CallInEditor, Category="LiveLink")
	float GetFPS() const;
...
protected:
	...
	virtual bool Consume(const FImageSourceInfo& SourceInfo, const TSharedPtr<IMediaPipeTexture>& Texture) override;
	...
	TQueue<TSharedPtr<IMediaPipeTexture>> FrameQueue;
public:
	// Called every frame
	virtual void Tick(float DeltaTime) override;
private:
	FCriticalSection EventSubMutex;
	FCriticalSection ThreadStartStopMutex;
	...
	TFuture<void> FaceSolutionInitFuture;
