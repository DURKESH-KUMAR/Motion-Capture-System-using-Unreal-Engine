...
UCLASS(Abstract)
class MEDIAPIPEMOTION_API AFaceLiveLinkActor : public AActor
{
	GENERATED_BODY()
public:
	...
	UFUNCTION(BlueprintPure, Category="MediaPipe", meta=(ReturnDisplayName= "Added"))
	bool IsLiveLinkSourceAdded() const;
