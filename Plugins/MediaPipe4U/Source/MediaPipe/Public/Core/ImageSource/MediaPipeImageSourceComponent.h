...
public:
	...
	bool bCloseWhenMediaPipeStopped = true;
	...
	virtual bool IsSupportHorizontalFlip() override PURE_VIRTUAL(
		UMediaPipeImageSourceComponent::IsSupportHorizontalFlip, return false;);

	virtual bool IsSupportLimitResolution() override PURE_VIRTUAL(
		UMediaPipeImageSourceComponent::IsSupportLimitResolution, return false;);
	...
	//control support
	virtual bool CanPauseOrResume() override { return false; }
	...
	virtual bool SeekToPercent(float Percent) override { return false; }
	virtual bool CanGetTime() override { return false; }
	virtual bool GetTime(int64& TotalMills, int64& CurrentMills) override { return false; }
	virtual bool CorrectFrame(FFrameTransform& InOutTransform) override { return false; }
	virtual bool NextFrame() override { return false; }

	virtual bool IsCloseWhenMediaPipeStopped() const override;
	virtual void Close() override PURE_VIRTUAL(UMediaPipeImageSourceComponent::Close,);
