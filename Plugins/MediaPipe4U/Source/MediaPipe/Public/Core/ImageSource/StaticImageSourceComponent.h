...
public:
	...
	//control support
	virtual bool CanPauseOrResume() override final { return false; }
	virtual bool Pause() override final { return false; }
	virtual bool Resume() override final { return false; }
	virtual bool CanSeek() override final { return false; }
	virtual bool SeekToPercent(float) override final { return false; }
	virtual bool NextFrame() override final { return false;}
	virtual bool CanGetTime() override final { return false; }
	virtual bool GetTime(int64&, int64&) override final { return false; }
	virtual bool IsPaused() override { return false; }

	virtual bool IsCloseWhenMediaPipeStopped() const override { return false; }
