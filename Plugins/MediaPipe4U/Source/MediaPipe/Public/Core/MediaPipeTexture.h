...
public:
	...
	bool AdoptCvMat(void* SrcMat, long DataSizeBytes);
	bool CopyFromCvMat(void* SrcMat);
	bool CopyFromData(const void* InData, SIZE_T DataSize);
...
private:
	mutable void* Mat = nullptr;
	mutable long MatSizeInBytes = 0;
